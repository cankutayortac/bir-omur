...
Ölçüm tarihi: 8 Eylül 2026. Bu dosya yeni gelişim ve ekonomi düzeninin ilk karşılaştırmasını kaydeder; uzun vadeli dengenin kusursuz olduğu iddiası değildir.

## Amaç ve değişiklikler

Bilgi, kuvvet ve karizmayı çocuklukta doldurmak yerine bir alana emek vermek, yeni yetkinlikler açmak ve yetişkinlikte hâlâ gelişebilmek hedefleniyor. Olumlu temel stat kazançları 40, 60, 80 ve 95 sonrasında kademeli azalır. Çocuklukta ek yumuşak sınırlar, aynı yıl tekrarda düşük verim, sağlık ve stresin öğrenmeye etkisi vardır. Küçük gelişimler onda bir puanla tutulur; olumsuz etkiler bu kazanç indirimiyle hafifletilmez.
...
Eski sürüm karşılaştırması Git geçmişindeki `09647ff` içeriğini kullanır. Her strateji, aynı 1–12 tohumlu 12 yeni hayatı 50 yaşına kadar çalıştırır: bilgi, kuvvet, karizma odaklı veya dengeli. Betik ekipmanı bütçesi yettiğinde alır, okul dışındaki yetişkinlikte başlangıç işine başvurur; düşük sağlık/yüksek streste dinlenmeyi önceliklendirir. Kalan zamanı görünür stat kazanımı/zaman oranını gözeterek kullanır. 18, 30 ve 50 yaş değerleri o yaşın eylemlerinden sonra ölçülür.
...
Odaklı satırlar yalnızca odaklanılan statın ortalamasıdır. Dengeli satırlar bilgi / kuvvet / karizma sırasındadır.

| Strateji | Eski sürüm, 18 yaş | Yeni, 18 yaş | Yeni, 30 yaş | Yeni, 50 yaş |
| --- | ---: | ---: | ---: | ---: |
| Bilgi odaklı | 100 | 65,3 | 83,5 | 95,7 |
| Kuvvet odaklı | 100 | 64,7 | 87,2 | 99,9 |
| Karizma odaklı | 100 | 64,3 | 85,7 | 99,1 |
| Dengeli | 100 / 100 / 100 | 60,9 / 59,6 / 60,5 | 79,5 / 79,4 / 77,1 | 87,8 / 87,7 / 87,7 |

Erken doygunluk bu denemede giderildi. Tek bir alana onlarca yıl yatırım yapan karakterin ileri yetişkinlikte 100'e yaklaşması hâlâ mümkün; bunun ne kadar eğlenceli olduğu oyun testleriyle değerlendirilmelidir.
...
## Kariyer yolu ve eğitim borcu denemesi
